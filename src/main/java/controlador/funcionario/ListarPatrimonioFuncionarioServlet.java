...
@WebServlet({ "/funcionario/patrimonio" })
public class ListarPatrimonioFuncionarioServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public ListarPatrimonioFuncionarioServlet() {
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("pathView", "/WEB-INF/views/funcionario/patrimonio.jsp");
